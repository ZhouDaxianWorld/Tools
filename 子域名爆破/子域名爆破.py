...
class Excel(object):
    ...
    def __init__(self, domain):
        self.excel_file_name = "result/" + domain + "-" + time.strftime("%Y%m%d%H%M", time.localtime()) + "的信息收集.xlsx"
...
if __name__ == "__main__":
    ...
    parse.add_option('--gevent', dest='gevent', action='store', type=int, metavar='gevent', help='域名')
